...
| [05 · Agentic GRPO](05_agentic_grpo.ipynb) | Prove stateful multi-turn RL and reward tests on a trusted toy environment | Reward fixtures pass; two independent real-harness runs beat the accepted adapter |
...
- GRPO uses groups of two for the initial memory smoke, masks truncated
  completions, unit-tests reward functions and monitors zero-variance reward
  groups.
