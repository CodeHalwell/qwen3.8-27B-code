    ...
    return notebook(
        ...
        [
            ...
            code(
                ...
                # Bootstrap corpus generated by scripts/generate_sft_corpus.py.
                # Upload the JSONL (or clone the repo) and point this at it.
                SOURCE_LOCAL_JSONL = ""  # e.g. "/content/trajectories.jsonl"
